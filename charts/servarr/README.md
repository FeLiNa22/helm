...
| `acestream.securityContext`                               | The security context to use for the container. By default, privileged mode is enabled to allow multicast operations.               | `{"privileged": true}`            |
