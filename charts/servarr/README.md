...
| `acestream.podSecurityContext.fsGroup`                    | The group ID to use for the pod.                                                                                                    | `1000`                            |
| `acestream.podSecurityContext.fsGroupChangePolicy`        | Policy for changing ownership and permissions of the volume.                                                                        | `OnRootMismatch`                  |
...
| `acestream.dispatcharr.env.PUID`                          | User ID for Dispatcharr process.                                                                                                    | `1000`                            |
| `acestream.dispatcharr.env.PGID`                          | Group ID for Dispatcharr process.                                                                                                   | `1000`                            |
| `acestream.dispatcharr.env.TZ`                            | Timezone for Dispatcharr.                                                                                                           | `Europe/London`                   |
| `acestream.dispatcharr.env.UMASK`                         | File creation mask for Dispatcharr.                                                                                                 | `002`                             |
...
| `acestream.persistence.size`                              | The size to use for the persistence.                                                                                                | `512Mi`                           |
| `acestream.persistence.backup.enabled`                    | Whether to enable backup persistence for Dispatcharr.                                                                               | `true`                            |
...
| `acestream.persistence.backup.size`                       | The size to use for the backup persistence.                                                                                         | `512Mi`                           |
