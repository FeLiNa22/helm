...
| `seerr.database.mode`                                 | Database mode: 'standalone' creates a single-instance PostgreSQL using CloudNativePG, 'external' uses an external PostgreSQL database, 'cluster' creates a multi-instance CloudNativePG cluster. | `standalone`               |
...
| `seerr.database.standalone.instances`                 | Number of PostgreSQL instances for standalone mode (default: 1).                                                                                                                                 | `1`                        |
| `seerr.database.standalone.storageClass`              | Storage class for the standalone PostgreSQL instance.                                                                                                                                            | `""`                       |
| `seerr.database.standalone.storageSize`               | Storage size for the standalone PostgreSQL instance.                                                                                                                                             | `5Gi`                      |
| `seerr.database.external.host`                        | Hostname of the external PostgreSQL database (required when mode is 'external').                                                                                                                 | `""`                       |
| `seerr.database.external.port`                        | Port of the external PostgreSQL database.                                                                                                                                                        | `5432`                     |
| `seerr.database.external.username`                    | Username for the external PostgreSQL database (required when mode is 'external').                                                                                                                | `""`                       |
| `seerr.database.external.password`                    | Password for the external PostgreSQL database. WARNING: For production, use existingSecret instead to avoid storing passwords in values files.                                                   | `""`                       |
| `seerr.database.external.existingSecret`              | Name of an existing secret containing the database password (key: 'password'). Recommended for production.                                                                                       | `""`                       |
