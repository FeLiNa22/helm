...
| `sonarr.database.persistence.size`                     | Size of the persistence volume (default: 100Mi).                                                                                               | `100Mi`                             |
...
| `prowlarr.database.persistence.size`                     | Size of the persistence volume (default: 100Mi).                                                                                               | `100Mi`                             |
...
| `seerr.database.persistence.size`                     | Size of the persistence volume (default: 100Mi).                                                                                               | `100Mi`                             |
...
| `radarr.database.persistence.size`                     | Size of the persistence volume (default: 100Mi).                                                                                               | `100Mi`                             |
...
| `lidarr.database.persistence.size`                     | Size of the persistence volume (default: 100Mi).                                                                                               | `100Mi`                             |
...
| `plex.persistence.cache.enabled`                     | Whether to enable cache persistence for the service.                                                                                | `true`                     |
| `plex.persistence.cache.storageClass`                | The storage class to use for cache persistence.                                                                                     | `""`                       |
| `plex.persistence.cache.accessMode`                  | The access mode to use for cache persistence.                                                                                       | `ReadWriteOnce`            |
| `plex.persistence.cache.size`                        | The size to use for cache persistence.                                                                                              | `1Gi`                      |
...
| `emby.securityContext.runAsUser`                     | The user ID to run the container as.                                                                                                | `1000`                     |
| `emby.securityContext.runAsGroup`                    | The group ID to run the container as.                                                                                               | `100`                      |
| `emby.securityContext.runAsNonRoot`                  | Whether to run the container as a non-root user.                                                                                    | `true`                     |
...
| `acestream.persistence.backup.enabled`                    | Whether to enable backup persistence for Dispatcharr.                                                                               | `false`                           |
| `acestream.persistence.backup.storageClass`               | The storage class to use for the backup persistence.                                                                                | `cephfs`                          |
| `acestream.persistence.backup.existingClaim`              | The name of an existing claim to use for the backup persistence.                                                                    | `""`                              |
| `acestream.persistence.backup.accessMode`                 | The access mode to use for the backup persistence.                                                                                  | `ReadWriteMany`                   |
| `acestream.persistence.backup.size`                       | The size to use for the backup persistence.                                                                                         | `5Gi`                             |
