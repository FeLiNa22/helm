...
| `seerr.deployment.strategy.type`                      | The deployment strategy to use.                                                                                                     | `Recreate`                         |
...
| `seerr.podSecurityContext`                            | The security context to use for the pod.                                                                                            | `{"fsGroup":1000,"fsGroupChangePolicy":"OnRootMismatch"}`                               |
| `seerr.securityContext`                               | The security context to use for the container.                                                                                      | `{"allowPrivilegeEscalation":false,"capabilities":{"drop":["ALL"]},"readOnlyRootFilesystem":false,"runAsNonRoot":true,"privileged":false,"runAsUser":1000,"runAsGroup":1000,"seccompProfile":{"type":"RuntimeDefault"}}`                               |
...
| `seerr.persistence.accessMode`                        | The access mode to use for the persistence.                                                                                         | `ReadWriteOnce`                    |
...
| `seerr.env`                                           | Additional environment variables to add to the pod.                                                                                 | `{}`                               |
