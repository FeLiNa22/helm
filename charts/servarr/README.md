...
| `sonarr.database.port`                                 | Port of the PostgreSQL database.                                                                                           | `5432`                       |
...
| `sonarr.database.external.username`                    | Username for the external PostgreSQL database.                                                                                      | `""`                         |
| `sonarr.database.external.password`                    | Password for the external PostgreSQL database (ignored if existingSecret is set).                                                   | `""`                         |
| `sonarr.database.external.existingSecret`              | Name of an existing secret containing the database password (key: 'password').                                                      | `""`                         |
...
| `prowlarr.database.port`                                 | Port of the PostgreSQL database.                                                                                           | `5432`                         |
...
| `prowlarr.database.external.username`                    | Username for the external PostgreSQL database.                                                                                      | `""`                           |
| `prowlarr.database.external.password`                    | Password for the external PostgreSQL database (ignored if existingSecret is set).                                                   | `""`                           |
| `prowlarr.database.external.existingSecret`              | Name of an existing secret containing the database password (key: 'password').                                                      | `""`                           |
...
| `seerr.database.port`                                 | Port of the PostgreSQL database.                                                                                           | `5432`                     |
...
| `radarr.database.port`                                 | Port of the PostgreSQL database.                                                                                           | `5432`                       |
...
| `radarr.database.external.username`                    | Username for the external PostgreSQL database.                                                                                      | `""`                         |
| `radarr.database.external.password`                    | Password for the external PostgreSQL database (ignored if existingSecret is set).                                                   | `""`                         |
| `radarr.database.external.existingSecret`              | Name of an existing secret containing the database password (key: 'password').                                                      | `""`                         |
...
| `lidarr.database.port`                                 | Port of the PostgreSQL database.                                                                                           | `5432`                       |
...
| `lidarr.database.external.username`                    | Username for the external PostgreSQL database.                                                                                      | `""`                         |
| `lidarr.database.external.password`                    | Password for the external PostgreSQL database (ignored if existingSecret is set).                                                   | `""`                         |
| `lidarr.database.external.existingSecret`              | Name of an existing secret containing the database password (key: 'password').                                                      | `""`                         |
...
| `emby.securityContext`                               | The security context to use for the container.                                                                                      | `{"runAsUser":1000,"runAsGroup":100,"runAsNonRoot":true}` |
...
| `emby.env.UID`                                       | The user ID to run emby as (default: 2).                                                                                            | `1000`                     |
| `emby.env.GID`                                       | The group ID to run emby as (default: 2).                                                                                           | `100`                      |
| `emby.env.GIDLIST`                                   | A comma-separated list of additional GIDs to run emby as (default: 2).                                                              | `100`                      |
