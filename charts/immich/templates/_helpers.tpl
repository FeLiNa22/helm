...
*/}}
{{- define "immich.database.name" -}}
{{- printf "%s-immich-db" .Release.Name }}
{{- end }}
...
{{- printf "%s-rw" (include "immich.database.name" .) }}
...
{{- else }}
{{- printf "%s-immich-db-app" .Release.Name }}
{{- end }}
{{- else if .Values.postgresql.enabled }}
