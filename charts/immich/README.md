...
| Name                                            | Description                                                                        | Value                                         |
| ----------------------------------------------- | ---------------------------------------------------------------------------------- | --------------------------------------------- |
| `dragonfly.enabled`                             | Enable the dragonfly subchart.                                                     | `true`                                        |
...
| `postgres.cluster.persistence.size`                         | Size of the persistence volume.                                                                                              | `512Mi`                                                                                                      |
| `postgres.cluster.persistence.storageClass`                 | Storage class for persistence.                                                                                               | `""`                                                                                                         |
| `postgres.cluster.postgresql.parameters`                    | Map of PostgreSQL configuration parameters to pass to the CNPG Cluster.                                                      | `{}`                                                                                                         |
...
| `postgres.restore.name`                                     | Optional backup filename to restore (e.g. immich_backup_20240101_120000.sql.gz). If empty, restores the latest valid backup. | `""`                                                                                                         |
