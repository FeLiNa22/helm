...
| `startupProbe.initialDelaySeconds`              | Initial delay in seconds before the startup probe is initiated.                                                                     | `30`                                    |
| `startupProbe.periodSeconds`                    | Period in seconds for the startup probe.                                                                                            | `5`                                     |
| `startupProbe.timeoutSeconds`                   | Timeout in seconds for the startup probe.                                                                                           | `1`                                     |
| `startupProbe.successThreshold`                 | Success threshold for the startup probe.                                                                                            | `1`                                     |
| `startupProbe.failureThreshold`                 | Failure threshold for the startup probe.                                                                                            | `30`                                    |
| `startupProbe.httpGet.scheme`                   | HTTP scheme for the startup probe.                                                                                                  | `HTTP`                                  |
| `startupProbe.httpGet.path`                     | HTTP path for the startup probe.                                                                                                    | `/`                                     |
| `startupProbe.httpGet.port`                     | HTTP port for the startup probe.                                                                                                    | `http`                                  |
